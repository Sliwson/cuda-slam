...
We did not expect CUDA implementations to bring better stability or noise tolerance but we did hope to achieve major execution time gains. All the performance test were run on the machine with the following configuration:
\begin{itemize}
