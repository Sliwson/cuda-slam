...
CPU solution of coherent point drift is based on algorithm description described in \cite{cpd}. It also uses Matlab code provided by authors. FGT algorithm implementation is based on Matlab implementation. %provide link
